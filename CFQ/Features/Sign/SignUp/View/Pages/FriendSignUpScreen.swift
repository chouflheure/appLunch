...
struct FriendSignUpScreen: View {
    ...
    var body: some View {
            ...
            ZStack {
                    ...
                    VStack {
                        if isLoadingUserUpload {
                            ...
                            LargeButtonView(
                                ...
                                isDisabled: isLoadingPictureUpload || isLoadingPictureUploadError || isLoadingPictureUploadDone || isLoadingUserUpload
                ...
                .blur(radius: isLoadingPictureUpload || isLoadingPictureUploadError || isLoadingPictureUploadDone ? 10 : 0)
                .allowsHitTesting(!isLoadingPictureUpload || !isLoadingPictureUploadError || !isLoadingPictureUploadDone)
...
#Preview {
    FriendSignUpScreen(viewModel: SignUpPageViewModel(uidUser: ""), coordinator: Coordinator()) {}
}
