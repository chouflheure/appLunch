...
struct AutoGrowingTextView: UIViewRepresentable {
    ...
    func updateUIView(_ uiView: UITextView, context: Context) {
        ...
        AutoGrowingTextView.recalculateHeight(view: uiView, result: $calculatedHeight, minHeight: minHeight)
    }

    static func recalculateHeight(view: UIView, result: Binding<CGFloat>, minHeight: CGFloat) {
    ...
    func makeCoordinator() -> Coordinator {
        return Coordinator(text: $text, height: $calculatedHeight, minHeight: minHeight)
    }
    ...
    class Coordinator: NSObject, UITextViewDelegate {
        ...
        init(text: Binding<String>, height: Binding<CGFloat>, minHeight: CGFloat) {
            self.text = text
            self.height = height
...
struct AutoGrowingTextView2: UIViewRepresentable {
    ...
    func updateUIView(_ uiView: UITextView, context: Context) {
        ...
        AutoGrowingTextView2.recalculateHeight(view: uiView, result: $calculatedHeight, minHeight: minHeight, maxHeight: maxHeight)
    ...
    func makeCoordinator() -> Coordinator {
        return Coordinator(text: $text, height: $calculatedHeight, minHeight: minHeight, maxHeight: maxHeight)
    }
    ...
    class Coordinator: NSObject, UITextViewDelegate {
        ...
        func textViewDidChange(_ textView: UITextView) {
            text.wrappedValue = textView.text
            AutoGrowingTextView2.recalculateHeight(view: textView, result: height, minHeight: minHeight, maxHeight: maxHeight)
        }
